...
**How it works:** The platform allows users to upload source code and subject them to targeted analysis (e.g., security, readability, refactoring). The backend (Spring Boot) orchestrates the inference using AI models—currently supporting Ollama (local) and Google (cloud API)—and produces a structured JSON report. The Angular frontend then processes this data to provide a clear, interactive visualization of the results.
