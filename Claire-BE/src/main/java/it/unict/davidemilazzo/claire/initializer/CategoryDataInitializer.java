...
public class CategoryDataInitializer implements CommandLineRunner {
    ...
    private final Set<AnalysisCategoryEntity> categories = new HashSet<>(List.of(
            new AnalysisCategoryEntity(null, AnalysisCategoryType.SECURITY,
                    ...
                    SpecializedAnalysisPrompts.getSecurityPrompt(EXAMPLE_CODE),
                    new ObjectMapper().valueToTree(SpecializedAnalysisPrompts.getSecuritySchema()),
                    new HashSet<>()),
            ...
            new AnalysisCategoryEntity(null,
                    ...
                    SpecializedAnalysisPrompts.getReliabilityPrompt(EXAMPLE_CODE),
                    new ObjectMapper().valueToTree(SpecializedAnalysisPrompts.getReliabilitySchema()),
                    new HashSet<>()),
            ...
            new AnalysisCategoryEntity(null, AnalysisCategoryType.PERFORMANCE,
                    ...
                    SpecializedAnalysisPrompts.getPerformancePrompt(EXAMPLE_CODE),
                    new ObjectMapper().valueToTree(SpecializedAnalysisPrompts.getPerformanceSchema()),
                    new HashSet<>()),
            ...
            new AnalysisCategoryEntity(null, AnalysisCategoryType.ARCHITECTURE_AND_DESIGN,
                    ...
                    SpecializedAnalysisPrompts.getArchitecturePrompt(EXAMPLE_CODE),
                    new ObjectMapper().valueToTree(SpecializedAnalysisPrompts.getArchitectureSchema()),
                    new HashSet<>()),
            ...
            new AnalysisCategoryEntity(null, AnalysisCategoryType.CODE_STRUCTURE_AND_COMPLEXITY,
                    ...
                    SpecializedAnalysisPrompts.getStructurePrompt(EXAMPLE_CODE),
                    new ObjectMapper().valueToTree(SpecializedAnalysisPrompts.getStructureSchema()),
                    new HashSet<>()),
            ...
            new AnalysisCategoryEntity(null, AnalysisCategoryType.NAMING_AND_DOCUMENTATION,
                    ...
                    SpecializedAnalysisPrompts.getNamingPrompt(EXAMPLE_CODE),
                    new ObjectMapper().valueToTree(SpecializedAnalysisPrompts.getNamingSchema()),
                    new HashSet<>())
    ));
